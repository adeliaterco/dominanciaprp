    ...
    <div className="relative p-8 rounded-3xl bg-gradient-to-br from-card to-muted border border-border shadow-card card-float">
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        ...
        <div className="flex items-center gap-2 px-4 py-2 bg-emerald/20 rounded-full">
          ...
          <span className="text-sm font-bold text-emerald">RECONQUISTA EN 7 DÍAS</span>
        </div>
      </div>
      ...
      <blockquote className="text-lg text-foreground italic mb-6 relative">
        ...
        Cuando apliqué el Protocolo de Dominancia Emocional, mi ex empezó a escribirme ella primero. En 7 días, estábamos de vuelta. 
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Reconquistó en 7 días</p>
        </div>
      </div>
    </div>
  );
